...
var estilo = document.querySelector("#estilos")

var botonW = document.querySelector("#botonWhite");

botonW.addEventListener("click", blanco);
function blanco() {
    estilo.setAttribute('href', 'css/whitestyle.css');
}


var botonN = document.querySelector("#botonBlack");

botonN.addEventListener("click", negro);
function negro() {
...
var check = document.querySelector('#checkboxPassword');
var passw = document.querySelector('#inputPassword');
...
function analizarContrasenia() {
    var password = document.getElementById('inputPassword');
    var texto = document.querySelector("#mensajePasswordEmpty");
    if (password.value === null || password.value === '') {
        texto.textContent = "No se ha ingresado contraseña. Por favor, ingrese una contraseña";
    }
    else {
        quitarMensajePassVacia();
        analizarSecuencia();
...
function mostrarCantidadesAnalisis(infoPassword) {
    ...
    // secNums.innerHTML = (Ejercicio 10)
    // secLetras.innerHTML = (Ejercicio 10)
    // secEspeciales.innerHTML = (Ejercicio 10)
